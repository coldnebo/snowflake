...
{	
  ...
  //LK: slight modification for cube seams...
  //hint from http://www.opengl.org/discussion_boards/ubbthreads.php?ubb=showflat&Number=132718
  //and page 296 of OpenGL SuperBible, 5th ed.
